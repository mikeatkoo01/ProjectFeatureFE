...
function DisplayCart() {
  ...
  const handleOrderTotalClick = (cart) => {
    cartTotal = calculateTotal(cart); 
    alert(`Total for ${cart.customer}'s cart: £${cartTotal.toFixed(2)}`); 
                ...
                <ul className="list-group list-group-flush">
                  ...
                  <li className="list-group-item">
                    <button
                      ...
                      onClick={() => handleOrderTotalClick(singleCart)} 
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-currency-pound" viewBox="0 0 16 16">
                    ...
                    {showCheckout && <Checkout selectedCart={singleCart} />}
                  </li>
                </ul>
              </div>
            </div>
